...
<?php
            while($row=@odbc_fetch_row($qryJornadas)){
                ...
                echo "<tr>";
                        ...
                        $parametros_jornada = "?li_id=" . $_GET['li_id'] . "&to_id=" . $_GET['to_id'] . "&jo_id=" . @odbc_result($qryJornadas,3) . "&jornada=" . @odbc_result($qryJornadas, 4);


                        echo "<td class='tabla_td'>" . @odbc_result($qryJornadas, 4);
                        echo "<td class='tabla_td'><a href='partidos_jornada.php".$parametros_jornada."'><img src='../img/icons8-services.gif' width='32' height='32'></a>";
                echo "</tr>";    
